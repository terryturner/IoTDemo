...
public class PahoMqttClient {
    ...
    public MqttAndroidClient getMqttClient(Context context, String brokerUrl, String clientId) {
        MqttDefaultFilePersistence filePersistence = new MqttDefaultFilePersistence(context.getDir("mqtt", MODE_PRIVATE).getAbsolutePath());
        mqttAndroidClient = new MqttAndroidClient(context, brokerUrl, clientId, filePersistence);
        try {
